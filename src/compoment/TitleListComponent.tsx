...
const TitleListComponent = ({ arr_list, onPressCell, styleProp }: TitleListComponentProps) => {
    ...
    return (
        <View style={[styles.container, styleProp]}>
            {arr_list.map((value, index) => {
                return (
                    <View key={index}>
                        <TouchableOpacity onPress={() => onPressCell ? onPressCell(value, index) : null}
                            style={[index === 0 ? styles.topSpaceInBoxSmall : styles.topSpaceInBox]}>
